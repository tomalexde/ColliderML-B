...
from Transformer.TrackTransformer_SDPA import TrackT_SDPA
from torchmetrics.classification import MulticlassConfusionMatrix


class LightningNeuralNetwork(pl.LightningModule):
    """NeuralNetwork for SDPA version. Batch = (x_padded, mask, y)."""
    ...
    def __init__(self, feature_dim=3, hidden_size=256, num_heads=8,
        ...
        self.model         = TrackT_SDPA(feature_dim, hidden_size, num_heads,
    ...
    def training_step(self, batch, batch_idx):
        x, mask, y = self._unpack(batch)
        loss = self.loss_function(self(x, mask), y)
